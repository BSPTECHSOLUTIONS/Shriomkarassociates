...
export function AutoPopup() {
  ...
  const handleWhatsApp = () => {
    ...
    const type = projectType || "General Inquiry";
    const message = `Hi Sri Omkar Associates! 👋\n\nI would like to book a free consultation.\n\n*Name:* ${name}\n*Phone:* ${phone}\n*Project Type:* ${type}\n\nPlease get in touch with me. Thank you!`;
    const encoded = encodeURIComponent(message);
    window.open(`https://wa.me/917204767373?text=${encoded}`, "_blank");
    setIsOpen(false);
  };
          ...
          >
            ...
            <div className="p-8 space-y-4">
              <input
                ...
                className="w-full h-12 px-4 rounded-lg bg-muted/50 border border-border text-sm focus:outline-none focus:ring-2 focus:ring-primary"
              />
              <input
                type="tel"
              ...
              <select
                ...
                className="w-full h-12 px-4 rounded-lg bg-muted/50 border border-border text-sm text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary"
              >
              ...
              <button
                ...
                disabled={!name || !phone}
                className="w-full h-12 rounded-lg bg-[#25D366] hover:bg-[#20b858] disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold text-base flex items-center justify-center gap-2 transition-colors"
              >
              ...
              <p className="text-center text-xs text-muted-foreground">
                We reply within a few minutes during business hours.
              </p>
            </div>
          </motion.div>
        </div>
